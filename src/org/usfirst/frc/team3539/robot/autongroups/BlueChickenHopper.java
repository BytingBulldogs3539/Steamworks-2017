 ...
 *
 */
public class BlueChickenHopper extends CommandGroup
{
	public BlueChickenHopper()
	{
		...
		addSequential(new SuperDriveAuton(115, .6, 50, false, 4, RobotMap.whiteLineDistance - 40));
